        ...
        VStack(spacing: 16) {
            ...
            VStack(alignment: .center, spacing: 8) {
                ...
                Text("Ежедневно с 10:00 до 20:00")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("​​Проспект Сейфуллина, 574/1 к3​, 1 этаж")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
            }

            HStack(spacing: 20) {
                Link("Instagram", destination: URL(string: "https://www.instagram.com/ness_beauty_place/")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)

                Link("WhatsApp", destination: URL(string: "https://wa.me/77713423222")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)
            }
            .padding()
...
struct Salon3DetailView_Previews: PreviewProvider {
