...
struct Salon1DetailView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Салон \"Montebello\"")
                .font(.title)
                .fontWeight(.bold)
                .foregroundColor(.primary)

            VStack(alignment: .center, spacing: 8) {
                Text("Ежедневно | 08:00-20:00")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("​Проспект Абая, 164/6 к6")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
            }

            HStack(spacing: 20) {
                Link("Instagram", destination: URL(string: "https://www.instagram.com/montebello_almaty/")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)

                Link("WhatsApp", destination: URL(string: "https://wa.me/77070505065")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)
            }
            .padding()
...
struct Salon1DetailView_Previews: PreviewProvider {
