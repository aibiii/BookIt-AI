        ...
        VStack(spacing: 16) {
            ...
            VStack(alignment: .center, spacing: 8) {
                ...
                Text("Ежедневно с 10:00 до 22:00")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("​​ул. Желтоксан, 166")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
            }

            HStack(spacing: 20) {
                Link("Instagram", destination: URL(string: "https://www.instagram.com/briolin.barbershop.kz/")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)

                Link("WhatsApp", destination: URL(string: "https://wa.me/77022108808")!)
                    .font(.subheadline)
                    .foregroundColor(.blue)
            }
            .padding()
...
struct Salon4DetailView_Previews: PreviewProvider {
